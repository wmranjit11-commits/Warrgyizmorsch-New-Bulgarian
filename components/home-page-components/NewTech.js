      ...
      <div ref={sectionRef} className="new-tech-section-container">
        ...
        <div className="container">
          <div className="new-tech-section-title new-tech-anim">
            <span className="new-italic">Интеграция</span>
          </div>
          <div className="new-tech-section-heading new-tech-anim">
            Задвижване на иновациите с правилния технологичен стек
          </div>
          <div className="new-tech-section-subtitle new-tech-anim">
            Warrgyizmorsch съчетава експертен опит в Python, JavaScript, PHP, HTML, SQL и др., 
            за да създава готови за бъдещето, високопроизводителни дигитални решения по целия свят.
          </div>

          <Link href={"/services"}>
          <button className="new-tech-section-button th-btn style-radius new-tech-anim">
            Всички услуги →
          </button>
          </Link>
        </div>
            ...
            {[
              ...
              <SwiperSlide key={tech}>
                <div className="logo-slide" style={{ "--i": String(i) }}>
                  <img src={`/assets/new-img/${tech}.png`} alt={tech} />
                </div>
              </SwiperSlide>
            ))}
          </Swiper>
        ...
        <div className="new-tech-section-logos">
          <Link href={"/laravel-development-service"}>
            <div
              className="new-tech-section-logo"
              style={{ top: "-2%", left: "10%" }}
            >
              <img src="/assets/new-img/laravel.png" alt="Laravel" />
            </div>
          </Link>
          <Link href={"/node-js-development-service"}>
            <div
              className="new-tech-section-logo"
              style={{ top: "2%", left: "22%" }}
            >
              <img src="/assets/new-img/nodejs.png" alt="Node.js" />
            </div>
          </Link>
          <Link href={"/magento-development-service"}>
            <div
              className="new-tech-section-logo"
              style={{ top: "18%", left: "5%" }}
            >
              <img src="/assets/new-img/magento.png" alt="magento" />
            </div>
          </Link>
          <Link href={"/shopify-development-service"}>
            <div
              className="new-tech-section-logo"
              style={{ top: "34%", left: "14%" }}
            >
              <img src="/assets/new-img/shopify.png" alt="Shopify" />
            </div>
          </Link>
          <Link href={"/angular-development-service"}>
            <div
              className="new-tech-section-logo"
              style={{ top: "51%", left: "7%" }}
            >
              <img src="/assets/new-img/angular.png" alt="Angular" />
            </div>
          </Link>
          <Link href={"/reactjs-developers"}>
            <div
              className="new-tech-section-logo"
              style={{ top: "57%", left: "20%" }}
            >
              <img src="/assets/new-img/react.png" alt="React" />
            </div>
          </Link>

          <Link href={"/react-native-hybrid-app-development"}>
            <div
              className="new-tech-section-logo"
              style={{ top: "3%", right: "17%" }}
            >
              <img src="/assets/new-img/reactnative.png" alt="React Native" />
            </div>
          </Link>
          <Link href={"/php-web-development-agency"}>
            <div
              className="new-tech-section-logo"
              style={{ top: "-1%", right: "6%" }}
            >
              <img src="/assets/new-img/php.png" alt="PHP" />
            </div>
          </Link>
          <Link href={"/woo-commerce-development-service"}>
            <div
              className="new-tech-section-logo"
              style={{ top: "24%", right: "4%" }}
            >
              <img src="/assets/new-img/woocommerce.png" alt="WooCommerce" />
            </div>
          </Link>
          <Link href={"/ui-ux-design-service"}>
            ...
            >
              <img src="/assets/new-img/figma.png" alt="Figma" />
            </div>
          </Link>
          <Link href={"/"}>
            <div
            ...
            >
              <img src="/assets/new-img/py.png" alt="Python" />
            </div>
          </Link>
          <Link href={"/flutter-app-development-company"}>
            ...
            >
              <img src="/assets/new-img/flutter.png" alt="Flutter" />
            </div>
          </Link>
        </div>
      </div>
